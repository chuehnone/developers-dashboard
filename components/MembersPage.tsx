                ...
                return (
                  <React.Fragment key={dev.id}>
                    ...
                    <tr className="hover:bg-slate-800/30 transition-colors group">
                      ...
                      {/* Comments Given */}
                      <td className="px-6 py-4">
                        {dev.commentGivenAnalysis && dev.commentGivenAnalysis.totalCommentsGiven > 0 ? (
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-6">
                              <div className="flex flex-col">
                                <span className="text-xs text-slate-500 uppercase font-semibold">Total Comments</span>
                                <div className="flex items-center gap-1 mt-0.5">
                              ...
                              <div className="flex flex-col">
                                <span className="text-xs text-slate-500 uppercase font-semibold">PRs Reviewed</span>
                                <div className="flex items-center gap-1 mt-0.5">
                    ...
                    {isExpanded && dev.commentGivenAnalysis && dev.commentGivenAnalysis.totalCommentsGiven > 0 && (
                      <tr className="bg-slate-800/20">
                        <td colSpan={4} className="px-6 py-4">
                          <div className="space-y-4">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="text-xs text-slate-400">
                                {dev.commentGivenAnalysis.totalCommentsGiven} comments across {dev.commentGivenAnalysis.totalPRsCommentedOn} PRs
                              </div>
                            </div>
                                      ...
                                      <tr key={pr.prId} className="hover:bg-slate-800/30 transition-colors">
                                        <td className="px-4 py-3">
                                          ...
                                          <div className="flex items-center gap-2 mt-1">
                                            ...
                                            />
                                            <span className="text-xs text-slate-500">by {pr.prAuthor}</span>
                                          </div>
                                        </td>
                                        <td className="px-4 py-3">
